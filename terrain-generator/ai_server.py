...
==================================================
Если в тексте есть (озеро, море,) -> "hasWater": true, "water_type": "lake"
Если в тексте есть (река, ручей) -> "hasWater": true, "water_type": "river"
Если воды нет -> "hasWater": false, "water_type": "none"
Если пользователь запрашивает оазис, то возвращай:
"type": "desert",
"biome": "desert",
"hasWater": true,
"water_type": "oasis"

Не используй "type": "oasis", если приложение не поддерживает такой отдельный тип.
==================================================
